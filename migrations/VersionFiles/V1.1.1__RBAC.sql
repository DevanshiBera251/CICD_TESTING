...
GRANT ROLE identifier($REPORTER) TO USER identifier($USER_NAME2);
GRANT ROLE identifier($INGESTION) TO USER identifier($USER_NAME2);
GRANT ROLE identifier($ENGINEER) TO USER identifier($USER_NAME2);

GRANT ROLE identifier($ADMIN) TO USER identifier($USER_NAME3);
GRANT ROLE identifier($REPORTER) TO USER identifier($USER_NAME3);
GRANT ROLE identifier($INGESTION) TO USER identifier($USER_NAME3);
GRANT ROLE identifier($ENGINEER) TO USER identifier($USER_NAME3);